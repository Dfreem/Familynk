global using Notification = Familynk.Models.Messages.Notification;
...
namespace Familynk.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        public NotificationController(FamilyContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Notification>> PostNotification(Notification notification)
        {
          if (_context.Notifications == null)
          {
              return Problem("Entity set 'FamilyContext.Notifications'  is null.");
          }
